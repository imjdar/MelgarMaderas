...
export default function ShowroomPage() {
  return (
    <section className="py-24 bg-[#120C08] text-white">
      <div className="max-w-[1500px] mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col">
            ...
            <div className="w-full aspect-video md:aspect-square lg:aspect-[4/3] bg-[#22170F] shadow-lg relative overflow-hidden border border-[#C59B27]/30">
              <iframe 
            ...
            <p className="mt-6 text-gray-300 font-light">
