...
export function SocialContactSection() {
  return (
    <section className="bg-white py-10 border-t border-gray-100" style={{ fontFamily: 'Inter, sans-serif' }}>
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 text-center">
        ...
        <div className="mb-8">
          ...
          <h2 className="text-4xl md:text-5xl font-light mb-4 text-[#3A1A0E]" style={{ fontFamily: '"Cormorant Garamond", serif' }}>
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-12">
          ...
          >
            ...
            <span className="text-sm font-medium tracking-widest uppercase text-gray-700 group-hover:text-[#d62976] transition-colors">Instagram</span>
          </a>
          ...
          >
            ...
            <span className="text-sm font-medium tracking-widest uppercase text-gray-700 group-hover:text-black transition-colors">TikTok</span>
          </a>
          ...
          >
            ...
            <span className="text-sm font-medium tracking-widest uppercase text-gray-700 group-hover:text-[#25D366] transition-colors">WhatsApp</span>
          </a>
